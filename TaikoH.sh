...
#更换blockpi：
#sed -i 's|^L1_ENDPOINT_HTTP=.*|L1_ENDPOINT_HTTP=http://95.217.74.216:8545|' ~/simple-taiko-node/.env
#sed -i 's|^L1_ENDPOINT_WS=.*|L1_ENDPOINT_WS=ws://95.217.74.216:8546|' ~/simple-taiko-node/.env
